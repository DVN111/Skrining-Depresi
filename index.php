...
-->
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm navbar-light">
        <div class="container">
            <a class="navbar-brand" href="index.php"><i class='uil uil-user'></i> Marvel</a>
            ...
            <div class="row">
                <div class="col-lg-7 col-md-12 col-12 d-flex align-items-center">
                    <div class="about-text">
                        ...
                        <p>Dengan Calmind kamu dapat mengecek apakah kamu sedang dalam kondisi depresi.
                          Kamu juga dapat menenangkan pikiranmu disini, karna juga tersedia musik penenang khusus unutk mu..</p>
                        
                        <div class="custom-btn-group mt-4">
                          <a href="login.php" class="btn custom-btn custom-btn-bg custom-btn-link">Daftar Sekarang</a>
                          <a href="main-guest.php" class="btn mr-lg-2 custom-btn">Coba Sebagai Guest</a>
                ...
                <div class="col-lg-5 col-md-12 col-12">
                    <div class="about-image svg">
                        <img src="images/undraw/undraw_messaging_fun_re_vic9.svg" class="img-fluid" alt="svg image">
                    </div>
                </div>
