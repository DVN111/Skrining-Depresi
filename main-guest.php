    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav mx-auto">
          <li class="nav-item">
            <a href="#" class="nav-link"><span data-hover="Skrining">Skrining</span></a>
          </li>
          <li class="nav-item">
            <a href="index.php" class="nav-link"><span data-hover="Back">Back</span></a>
          </li>
        </ul>
      ...
      <div class="container">
        <div class="row">
          <div class="card">
            ...
            <div class="card-body">
            <?php
            echo '<h5 class="card-title">Fitur tidak tersedia sebagai guest</h5>';
            echo '<p class="card-text">Silahkan Login Untuk Melihat Selengkapnya</p>';
